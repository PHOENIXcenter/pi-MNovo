...
class CTCBeamSearchDecoder(CTCDecoderBase):
    ...
    def __init__(self, decoder, decoder_parameters: Dict) -> None:
        ...
        beam_width = int(decoder_parameters.get("beam_width", decoder_parameters.get("beam", 10)))
    ...
    def _decode_raw(self, probabilities: TensorType):
        beam_results, beam_scores, timesteps, out_lens = self.decoder.decode(probabilities)
    ...
    def decode_all(self, probabilities: TensorType):
        ...
        beam_results, beam_scores, _timesteps, _out_lens = self._decode_raw(probabilities)
