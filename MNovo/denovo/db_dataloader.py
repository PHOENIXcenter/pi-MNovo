...
class MyRandomSampler(torch.utils.data.Sampler):
    ...
    def __iter__(self):
        ...
        LOGGER.debug("Sampler offsets: %s", offset)
...
class DeNovoDataModule(pl.LightningDataModule):
    ...
    def prepare_data(self) -> None:
        ...
        def build_or_reuse(index_path, filenames):
            ...
            DB_Index(index_path, filenames, self.ms_level, self.valid_charge, self.annotated, lock=lock)
    ...
    def train_dataloader(self) -> torch.utils.data.DataLoader:
        ...
        M = self.train_num_samples if self.train_num_samples is not None else 1000000
