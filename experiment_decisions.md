...
- **Evidence reviewed:** Frozen manuscript component manifest; SHA256 and embedded-component verification; exact equality of all 286 backbone tensors before and after path sanitization; clean-environment installation; static checks; 17 unit tests; and a two-spectrum end-to-end synthetic-MGF smoke test.
